...

{
	...
	Game.Notify('Outdated version', ' Hey there, you are currently playing the old and outdated Pastebin version 1.5.1 of <b>Darky\'s Achievement Package</b>. To get the newest version and upcoming future updates as well as the new mod <b>Darky\'s Armful Collection of Upgrades</b>, you should check out it\'s dedicated <a target="_blank" rel="noopener noreferrer" href="https://github.com/DarkSoul1800/DarkysBatch">Github</a> which also holds another new mod called <b>Darky\'s Achievements and Upgrades Batch</b> which features both the Package and the Collection in 1. This Pastebin version will <b>not</b> receive any more updates, so I recommend you switch over to the Github version. Thank you and I hope you continue to enjoy my mods!', [8, 0]);
}
